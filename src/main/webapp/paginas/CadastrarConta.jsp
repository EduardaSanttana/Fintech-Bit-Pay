  ...
  <div class="card-body pt-4 px-6 pb-6">
    ...
    <form action="../cadastrar" method="post" class="grid grid-cols-1 gap-3">
      ...
      <label class="form-control">
        ...
        <input name="nome" required class="input input-bordered h-10 text-sm" />
      </label>

      <label class="form-control">
        <span class="label-text">Email</span>
        <input name="email" type="email" required class="input input-bordered h-10 text-sm" />
      </label>

      <label class="form-control">
        <span class="label-text">Senha</span>
        <input name="senha" type="password" required class="input input-bordered h-10 text-sm" />
      </label>

      <label class="form-control">
        <span class="label-text">CPF</span>
        <input name="cpf" required class="input input-bordered h-10 text-sm" />
      </label>

      <label class="form-control">
        <span class="label-text">Data de nascimento</span>
        <input name="dataNascimento" type="date" required class="input input-bordered h-10 text-sm" />
      </label>

      <div class="grid grid-cols-3 gap-3">
        <label class="form-control col-span-2">
          <span class="label-text">Logradouro</span>
          <input name="logradouro" class="input input-bordered h-10 text-sm" />
        </label>
      ...
      <div class="grid grid-cols-3 gap-3">
        <label class="form-control col-span-2">
          ...
          <input name="cidade" class="input input-bordered h-10 text-sm" />
        </label>

        <label class="form-control">
          <span class="label-text">Estado</span>
          <input name="estado" maxlength="2" class="input input-bordered h-10 text-sm uppercase" />
        </label>
      </div>
