		...
		<div class="max-w-4xl mx-auto mt-12 p-6">
			<div class="card bg-base-100 shadow-xl">
				<div class="card-body p-6">
					<h2 class="text-3xl font-bold text-primary mb-6">Contas
						pendentes de aprovação</h2>
							...
							<tbody>
								...
								<tr>
									...
									<td class="flex gap-2">
										...
										<form
											action="${pageContext.request.contextPath}/alterar-situacao-conta"
											method="post">
								...
								%>
								<tr>
									<td colspan="4" class="text-error text-center">Nenhuma
										conta pendente encontrada.</td>
								</tr>
								<%
								}
								%>
