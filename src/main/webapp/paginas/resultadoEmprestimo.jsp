	...
	<div class="max-w-6xl mx-auto pt-12">
		...
		<div class="card bg-base-100 shadow-xl">
			<div class="card-body">
				...
				<h2 class="card-title text-2xl text-primary">Resultado da
					Simulação</h2>
				...
				<div class="overflow-x-auto mt-6">
					<table class="table table-zebra w-full">
						...
						<tbody>
							...
							<%
    List<Emprestimo> tabela = (List<Emprestimo>) request.getAttribute("tabela");

    if (tabela != null) {
        for (Emprestimo e : tabela) {
%>
							<tr>
								<td><%= e.getParcela() %></td>
								...
								<td class="font-bold text-primary">R$ <%= String.format("%.2f", e.getValorParcela()) %>
								</td>
							</tr>
							<%
        }
...
%>
				...
				<div class="mt-6">
					<a href="paginas/Emprestimo.jsp" class="btn btn-outline"> Nova
						Simulação </a>
				</div>
