...
public class ExtratoDAO {
    ...
    // LISTAR TODOS OS EXTRATOS DA CONTA (SEM FILTRO)
    public List<Extrato> listarTodos(int contaId) throws Exception {
    ...
    public List<Extrato> listarPorPeriodo(int contaId, String inicio, String fim) throws Exception {
        List<Extrato> lista = new ArrayList<>();

        String sql = "SELECT * FROM EXTRATOS "
                   + "WHERE CONTA_ID = ? "
